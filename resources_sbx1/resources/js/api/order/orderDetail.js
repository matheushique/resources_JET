...
function printDiv(divID) {
    ...
    document.body.innerHTML =
        ...
        "<div class='ui eight wide tablet four wide computer column'><a href='/Home'><img class='ui middle aligned image' src='/assets/image/logo/logo-casacapri.png' alt='' onerror=\"imgError(this)\"></a></div></br>" +
        divElements + "</body>";
    window.print();
